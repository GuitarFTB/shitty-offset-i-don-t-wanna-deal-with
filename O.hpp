...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-6776addb8fbc4d17";
    ...
    namespace AnimationTrack {
         ...
         inline constexpr uintptr_t IsPlaying = 0xa08;
    ...
    namespace Animator {
         inline constexpr uintptr_t ActiveAnimations = 0x848;
    }
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x79db650;
    }
    ...
    namespace Player {
         ...
         inline constexpr uintptr_t Mouse = 0xdc8;
    ...
    namespace PlayerConfigurer {
         inline constexpr uintptr_t Pointer = 0x7936ef0;
    }
